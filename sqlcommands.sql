CREATE TABLE cars ( 
    ...
    model VARCHAR(50) NOT NULL, --stores Car model eg Model X, up to 100 characters, must be entered
); 
...
CREATE TABLE students(
    ...
    student_house VARCHAR(20) NOT NULL, --stores Student house eg Hay as a string, must be entered
